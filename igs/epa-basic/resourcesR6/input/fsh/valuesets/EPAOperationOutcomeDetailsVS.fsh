ValueSet: EPAOperationOutcomeDetailsVS
Id: epa-operation-outcome-details
Title: "EPA Operation Outcome ValueSet"
Description: "Definition aller OperationOutcome-Codes, die im ePA-Kontext verwendet werden."
* insert Meta-VS
...
* include codes from valueset TIOperationOutcomeDetailsVS
* include codes from system EPAOperationOutcomeDetailsCS

// expansion of explicitly defined codes
* ^expansion.timestamp = "2025-05-21T14:56:00.000Z"
